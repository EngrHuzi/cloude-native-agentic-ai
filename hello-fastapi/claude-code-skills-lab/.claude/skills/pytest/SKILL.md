---
name: pytest
description: Comprehensive Python testing framework guide covering test creation, fixtures, parametrization, debugging, and best practices. Use when Claude needs to work with pytest for (1) Setting up pytest in a project, (2) Writing unit tests or integration tests, (3) Using fixtures and parametrization, (4) Running tests with coverage, (5) Debugging test failures, (6) Configuring pytest or CI/CD integration, or any other pytest-related tasks.
---
...
pytest -k "test_add"  # pattern matching
```
...
```bash
pytest --pdb  # Use Python debugger
```
